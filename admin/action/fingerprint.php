...
<body>
        ...
        <nav class="navbar navbar-inverse">
          <div class="container-fluid">
            <div class="navbar-header">
              <span class="navbar-brand" style="color: white;">Fingerprint WebAPI</span>
            </div>
              ...
              <form name="myForm" style="border: solid grey; padding:5px;">
                ...
                <table>
                  ...
                  <tr data-toggle="tooltip" title="Will save data to a .png file.">
                    <td>
                      <input type="checkbox" name="PngImage" checked value="4" onclick="checkOnly(this)"> PNG
                    </td>
                  </tr>
                </table>
              </form>
    ...
    <script src="scripts/memberfingerprint.js"></script>
