...
<div class="container mt-5">
    <h2 class="mb-4 text-center">Workout Program by Muscle Group</h2>
    <div class="row g-4 justify-content-center">
        ...
        foreach ($muscle_groups as $muscle => $img): ?>
            <div class="col-6 col-md-4 d-flex">
                <a href="<?= strtolower($muscle) ?>.php" class="text-decoration-none text-dark w-100">
